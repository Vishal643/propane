...
const SubNav =()=>{
    ...
    return(
        ...
        <div className={styles.subnav_wrapper}>
           ...
           <Button style={{ backgroundColor:"#0270DF"}}aria-describedby={id} variant="contained" color="primary" onClick={handleClick}>
                <AiOutlineSearch/> 
            </Button>
            ...
            <Popover
             ...
             >
               <div className={styles.subnav_input}>
                   <input placeholder="Search News" value={find} onChange={(e)=> setFind(e.target.value)}/>
