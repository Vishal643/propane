import {
	GET_BUSINESSAPI_FAILURE,
	GET_BUSINESSAPI_REQUEST,
	GET_BUSINESSAPI_SUCCESS,
	GET_BUSINESS_INDIA_REQUEST,
	GET_BUSINESS_INDIA_SUCCESS,
	GET_BUSINESS_INDIA_FAILURE,
...
const getBusinessIndia = (params) => (dispatch) => {
	...
	return axios
		.get('https://vishal-s-json-server.herokuapp.com/indian_business_news')
...
const getBusinessInternational = (params) => (dispatch) => {
	...
	return axios
		.get('https://vishal-s-json-server.herokuapp.com/international_business_news')
		.then((res) =>
			dispatch(getBusinessInternationalSuccess(res.data, 'International')),
		)
